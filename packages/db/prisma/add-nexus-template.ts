            ...
            children: [
              {
                ...
                children: [
                  { id: 'deals-title', type: 'Heading', props: { level: 2, text: 'Tagesangebote' }, style: { base: { fontSize: '28px', fontWeight: '700', letterSpacing: '-0.5px' } }, actions: [], meta: { name: 'Deals Title' }, children: [] },
                ...
                children: [
                  {
                    ...
                    type: 'Card',
                    props: {},
                    style: { base: { backgroundColor: '#ffffff', borderRadius: '8px', padding: '20px', position: 'relative', border: '1px solid #e5e7eb' } },
                    actions: [],
                    meta: { name: 'Deal 1' },
                    children: [
                      { id: 'd1-badge', type: 'Text', props: { text: '-45%' }, style: { base: { position: 'absolute', top: '12px', left: '12px', backgroundColor: '#ef4444', color: '#ffffff', padding: '4px 10px', fontSize: '12px', fontWeight: '700', borderRadius: '4px' } }, actions: [], meta: { name: 'Rabatt Badge' }, children: [] },
                      { id: 'd1-img', type: 'Image', props: { src: 'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=400&h=400&fit=crop', alt: 'Wireless Earbuds' }, style: { base: { width: '100%', height: '160px', objectFit: 'cover', marginBottom: '16px', borderRadius: '6px' } }, actions: [], meta: { name: 'Produkt Bild' }, children: [] },
                      { id: 'd1-title', type: 'Text', props: { text: 'Wireless Earbuds Pro' }, style: { base: { fontSize: '14px', fontWeight: '600', marginBottom: '8px', color: '#111827' } }, actions: [], meta: { name: 'Titel' }, children: [] },
                      { id: 'd1-price', type: 'Stack', props: { direction: 'row', gap: 'sm', align: 'center' }, style: { base: { display: 'flex', gap: '8px', alignItems: 'center' } }, actions: [], meta: { name: 'Preis' }, children: [
                        { id: 'd1-old', type: 'Text', props: { text: '149 €' }, style: { base: { fontSize: '13px', color: '#9ca3af', textDecoration: 'line-through' } }, actions: [], meta: { name: 'Alt' }, children: [] },
                        { id: 'd1-new', type: 'Text', props: { text: '82 €' }, style: { base: { fontSize: '16px', color: '#ef4444', fontWeight: '700' } }, actions: [], meta: { name: 'Neu' }, children: [] },
                      ] },
                    ],
                  },
                  {
                    ...
                    meta: { name: 'Deal 2' },
                    children: [
                      { id: 'd2-badge', type: 'Text', props: { text: '-40%' }, style: { base: { position: 'absolute', top: '12px', left: '12px', backgroundColor: '#ef4444', color: '#ffffff', padding: '4px 10px', fontSize: '12px', fontWeight: '700', borderRadius: '4px' } }, actions: [], meta: { name: 'Rabatt Badge' }, children: [] },
                      { id: 'd2-img', type: 'Image', props: { src: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop', alt: 'Smart Watch' }, style: { base: { width: '100%', height: '160px', objectFit: 'cover', marginBottom: '16px', borderRadius: '6px' } }, actions: [], meta: { name: 'Produkt Bild' }, children: [] },
                      { id: 'd2-title', type: 'Text', props: { text: 'Smart Watch Ultra' }, style: { base: { fontSize: '14px', fontWeight: '600', marginBottom: '8px', color: '#111827' } }, actions: [], meta: { name: 'Titel' }, children: [] },
                      { id: 'd2-price', type: 'Stack', props: { direction: 'row', gap: 'sm', align: 'center' }, style: { base: { display: 'flex', gap: '8px', alignItems: 'center' } }, actions: [], meta: { name: 'Preis' }, children: [
                        { id: 'd2-old', type: 'Text', props: { text: '299 €' }, style: { base: { fontSize: '13px', color: '#9ca3af', textDecoration: 'line-through' } }, actions: [], meta: { name: 'Alt' }, children: [] },
                        { id: 'd2-new', type: 'Text', props: { text: '179 €' }, style: { base: { fontSize: '16px', color: '#ef4444', fontWeight: '700' } }, actions: [], meta: { name: 'Neu' }, children: [] },
                      ] },
                    ],
                  },
                  {
                    ...
                    meta: { name: 'Deal 3' },
                    children: [
                      { id: 'd3-badge', type: 'Text', props: { text: '-45%' }, style: { base: { position: 'absolute', top: '12px', left: '12px', backgroundColor: '#ef4444', color: '#ffffff', padding: '4px 10px', fontSize: '12px', fontWeight: '700', borderRadius: '4px' } }, actions: [], meta: { name: 'Rabatt Badge' }, children: [] },
                      { id: 'd3-img', type: 'Image', props: { src: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=400&fit=crop', alt: 'Gaming Headset' }, style: { base: { width: '100%', height: '160px', objectFit: 'cover', marginBottom: '16px', borderRadius: '6px' } }, actions: [], meta: { name: 'Produkt Bild' }, children: [] },
                      { id: 'd3-title', type: 'Text', props: { text: 'Gaming Headset RGB' }, style: { base: { fontSize: '14px', fontWeight: '600', marginBottom: '8px', color: '#111827' } }, actions: [], meta: { name: 'Titel' }, children: [] },
                      { id: 'd3-price', type: 'Stack', props: { direction: 'row', gap: 'sm', align: 'center' }, style: { base: { display: 'flex', gap: '8px', alignItems: 'center' } }, actions: [], meta: { name: 'Preis' }, children: [
                        { id: 'd3-old', type: 'Text', props: { text: '89 €' }, style: { base: { fontSize: '13px', color: '#9ca3af', textDecoration: 'line-through' } }, actions: [], meta: { name: 'Alt' }, children: [] },
                        { id: 'd3-new', type: 'Text', props: { text: '49 €' }, style: { base: { fontSize: '16px', color: '#ef4444', fontWeight: '700' } }, actions: [], meta: { name: 'Neu' }, children: [] },
                      ] },
                    ],
                  },
                  {
                    ...
                    meta: { name: 'Deal 4' },
                    children: [
                      { id: 'd4-badge', type: 'Text', props: { text: '-50%' }, style: { base: { position: 'absolute', top: '12px', left: '12px', backgroundColor: '#ef4444', color: '#ffffff', padding: '4px 10px', fontSize: '12px', fontWeight: '700', borderRadius: '4px' } }, actions: [], meta: { name: 'Rabatt Badge' }, children: [] },
                      { id: 'd4-img', type: 'Image', props: { src: 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=400&fit=crop', alt: 'Bluetooth Speaker' }, style: { base: { width: '100%', height: '160px', objectFit: 'cover', marginBottom: '16px', borderRadius: '6px' } }, actions: [], meta: { name: 'Produkt Bild' }, children: [] },
                      { id: 'd4-title', type: 'Text', props: { text: 'Bluetooth Speaker' }, style: { base: { fontSize: '14px', fontWeight: '600', marginBottom: '8px', color: '#111827' } }, actions: [], meta: { name: 'Titel' }, children: [] },
                      { id: 'd4-price', type: 'Stack', props: { direction: 'row', gap: 'sm', align: 'center' }, style: { base: { display: 'flex', gap: '8px', alignItems: 'center' } }, actions: [], meta: { name: 'Preis' }, children: [
                        { id: 'd4-old', type: 'Text', props: { text: '79 €' }, style: { base: { fontSize: '13px', color: '#9ca3af', textDecoration: 'line-through' } }, actions: [], meta: { name: 'Alt' }, children: [] },
                        { id: 'd4-new', type: 'Text', props: { text: '39 €' }, style: { base: { fontSize: '16px', color: '#ef4444', fontWeight: '700' } }, actions: [], meta: { name: 'Neu' }, children: [] },
                      ] },
                    ],
                  },
                ],
                ...
                children: [
                  {
                    ...
                    type: 'Container',
                    props: {},
                    style: { base: { backgroundColor: '#f9fafb', borderRadius: '8px', padding: '16px', border: '1px solid #e5e7eb' } },
                    actions: [],
                    meta: { name: 'Produkt 1' },
                    children: [
