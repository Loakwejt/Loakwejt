...
import { Layers, Github, CheckCircle, Chrome } from 'lucide-react';
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center">
        ...
        <CardDescription>Starten Sie noch heute mit Builderly</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-3 pt-2">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-muted-foreground">
                Ich möchte gelegentlich Updates und Tipps per E-Mail erhalten. (optional)
              </span>
            </label>
          </div>
