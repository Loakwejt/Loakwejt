...
// POST /api/workspaces/[workspaceId]/sites/[siteId]/domains/[domainId]/verify
// Checks DNS records and verifies the domain
export async function POST(
  request: NextRequest,
  { params }: { params: { workspaceId: string; siteId: string; domainId: string } }
) {
  ...
  const domain = await prisma.customDomain.findFirst({
    where: { id: params.domainId, siteId: params.siteId },
  });
...
// DELETE /api/workspaces/[workspaceId]/sites/[siteId]/domains/[domainId]
