...
// GET /api/workspaces/[workspaceId]/sites/[siteId]/pages/[pageId]/revisions/[revisionId]
export async function GET(
  request: NextRequest,
  { params }: { params: { workspaceId: string; siteId: string; pageId: string; revisionId: string } }
) {
  try {
