...
// POST /api/runtime/sites/[siteSlug]/auth/login
...
export async function POST(
  ...
  try {
    ...
    await createAuditLog({ action: 'SITE_USER_LOGIN', entity: 'SiteUser', entityId: siteUser.id, details: { siteSlug: params.siteSlug, email: siteUser.email } });
